(function ($) {
    ...
    $.fn.mauGallery.listeners = function (options) {
        ...
        $(".mg-prev").on("click", () => $.fn.mauGallery.methods.prevImage(options.lightboxId));
        $(".mg-next").on("click", () => $.fn.mauGallery.methods.nextImage(options.lightboxId));
        $(".mg-prev").on("keydown", (event) => {
            if (event.key === "Enter") {
                $
                    .fn
                    .mauGallery
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-body">
              ${navigation
                    ? `<div class="mg-prev" tabindex="0" aria-label="Previous" style="cursor:pointer;position:absolute;top:50%;left:-15px;background:white;"><</div>`
                    : `<span style="display:none;" />`}
              <img class="lightboxImage img-fluid" alt="Contenu de l'image affichée dans la modale au clique"/>
              ${navigation
                        ? `<div class="mg-next" tabindex="0" aria-label="Next" style="cursor:pointer;position:absolute;top:50%;right:-15px;background:white;">></div>`
                        : `<span style="display:none;" />`}
            </div>
          </div>
        </div>
    ...
    `);
        ...
        showItemTags(gallery, position, tags) {
            var tagItems = '<li class="nav-item"><span class="nav-link active active-tag" tabindex="0" role=' +
                    '"button" data-images-toggle="all">Tous</span></li>';
            $.each(tags, function (index, value) {
                tagItems += `<li class="nav-item active">
              <span class="nav-link" tabindex="0" role="button" data-images-toggle="${value}">${value}</span></li>`;
            });
